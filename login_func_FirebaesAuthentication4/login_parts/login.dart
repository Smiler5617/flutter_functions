                ...
                ButtonTheme(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      // Google認証の部分
                      _googleUser = await _google_signin.signIn();
                      ...
                      try {
                        _result = await _auth.signInWithCredential(_credential);
                        _user = _result.user;

                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Home(user_id: _user.uid, google_signin: _google_signin, auth: _auth),
                          )
                        );
